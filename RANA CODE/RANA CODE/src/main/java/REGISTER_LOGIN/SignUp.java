...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBacktoLogin.setForeground(new java.awt.Color(0, 102, 255));
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
            ...
            if (!errorOccurred) {
                try {
                    BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Darel Briones\\OneDrive\\Documents\\RANA CODE\\RANA CODE\\LIBRARY MANAGEMENT ACCOUNT INFORMATION\\" + email_num + ".txt", true)); 
                    
                    writer.write("----------------------------");
                    writer.newLine();
                    writer.write("LIBRARY MANAGEMENT ACCOUNT INFORMATION");
                    writer.newLine();
                    writer.write("----------------------------");
                    writer.newLine();
                    ...
                    writer.newLine();
                    writer.close();
                    JOptionPane.showMessageDialog(this, "Library account has been createed successfully!", "Registration Successful", JOptionPane.INFORMATION_MESSAGE);
                    txtFname.setText("");
                    txtLname.setText("");
    ...
    File directory = new File("C:\\Users\\Darel Briones\\OneDrive\\Documents\\RANA CODE\\RANA CODE\\LIBRARY MANAGEMENT ACCOUNT INFORMATION\\");
